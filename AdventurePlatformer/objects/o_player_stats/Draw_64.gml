...
if (room == r_title) {
	...
	draw_text_colour(room_width / 2 + 4, 24 + 6, "Adventure Platformer", c_black, c_black, c_black, c_black, 1);
	draw_text_colour(room_width / 2, 24, "Adventure Platformer", c_white, c_white, c_white, c_white, 1);
